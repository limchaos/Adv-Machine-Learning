...
GreedyPolicy <- function(x, y
  ...
  action0 = ifelse(length(max_q_index) > 1, sample(max_q_index, 1),max_q_index)
...
EpsilonGreedyPolicy <- function(x, y, epsilon){
  ...
  # Your code here.
  action = ifelse(rnorm(1)>epsilon, GreedyPolicy(x,y), sample(1:4, 1))
...
q_learning <- function(start_state, epsilon = 0.5, alpha = 0.1, gamma = 0.95, 
  ...
  repeat{
    ...
    q_table[new_state[1],new_state[2],action] <<- Q_old + alpha * temporal_difference  
