...
$$P(S|B,L,E,D,X,T,A) = \frac{P(S)P(B|S)P(L|S)P(E,D,X,T,A|B,L,\textcolor{red}{S})}{\sum_SP(S)P(B|S)P(L|S)P(E,D,X,T,A|B,L)}$$
$$~~~~~~~~~~~~~~~~~~~~~~~~\approx\frac{P(S)P(B|S)P(L|S)}{\sum_SP(S)P(B|S)P(L|S)}=\frac{P(S,B,L)}{P(B,L)}=P(S|B,L)$$
