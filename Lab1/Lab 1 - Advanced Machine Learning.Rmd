...
**By different start way in each score**
...
Intuitively, by visualizing the results, for some score criterions,esp. aic,bdj,bde,bds..., the results for different initial values have some significant differences in the number of edges.
...
From the results below, all the results in each score criterion are not equivalent. 
...
# Create structure
structure <- hc(train)
fit <- bn.fit(x = structure, data = train)  # training data
...
[lacking the point of why the same ]
